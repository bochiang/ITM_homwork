                          ...
                          int iStride, int ipix_x, int ipix_c_y, int ipix_c_x, int iStrideC )
{
    ...
    if ( b8 < 4 )
    {
        if ( 4 == bsize )
        {
            ...
            M0 = _mm_set_epi32( ppredblk[bx + 3][by + 0], ppredblk[bx + 2][by + 0], ppredblk[bx + 1][by + 0], ppredblk[bx + 0][by + 0] );
            M1 = _mm_set_epi32( ppredblk[bx + 3][by + 1], ppredblk[bx + 2][by + 1], ppredblk[bx + 1][by + 1], ppredblk[bx + 0][by + 1] );
            M2 = _mm_set_epi32( ppredblk[bx + 3][by + 2], ppredblk[bx + 2][by + 2], ppredblk[bx + 1][by + 2], ppredblk[bx + 0][by + 2] );
            M3 = _mm_set_epi32( ppredblk[bx + 3][by + 3], ppredblk[bx + 2][by + 3], ppredblk[bx + 1][by + 3], ppredblk[bx + 0][by + 3] );
        ...
        else if ( 8 == bsize )
        {
            ...
            M10 = _mm_set_epi32( ppredblk[bx + 3][by + 0], ppredblk[bx + 2][by + 0], ppredblk[bx + 1][by + 0], ppredblk[bx + 0][by + 0] );
            M20 = _mm_set_epi32( ppredblk[bx + 7][by + 0], ppredblk[bx + 6][by + 0], ppredblk[bx + 5][by + 0], ppredblk[bx + 4][by + 0] );

            M11 = _mm_set_epi32( ppredblk[bx + 3][by + 1], ppredblk[bx + 2][by + 1], ppredblk[bx + 1][by + 1], ppredblk[bx + 0][by + 1] );
            M21 = _mm_set_epi32( ppredblk[bx + 7][by + 1], ppredblk[bx + 6][by + 1], ppredblk[bx + 5][by + 1], ppredblk[bx + 4][by + 1] );

            M12 = _mm_set_epi32( ppredblk[bx + 3][by + 2], ppredblk[bx + 2][by + 2], ppredblk[bx + 1][by + 2], ppredblk[bx + 0][by + 2] );
            M22 = _mm_set_epi32( ppredblk[bx + 7][by + 2], ppredblk[bx + 6][by + 2], ppredblk[bx + 5][by + 2], ppredblk[bx + 4][by + 2] );

            M13 = _mm_set_epi32( ppredblk[bx + 3][by + 3], ppredblk[bx + 2][by + 3], ppredblk[bx + 1][by + 3], ppredblk[bx + 0][by + 3] );
            M23 = _mm_set_epi32( ppredblk[bx + 7][by + 3], ppredblk[bx + 6][by + 3], ppredblk[bx + 5][by + 3], ppredblk[bx + 4][by + 3] );

            M14 = _mm_set_epi32( ppredblk[bx + 3][by + 4], ppredblk[bx + 2][by + 4], ppredblk[bx + 1][by + 4], ppredblk[bx + 0][by + 4] );
            M24 = _mm_set_epi32( ppredblk[bx + 7][by + 4], ppredblk[bx + 6][by + 4], ppredblk[bx + 5][by + 4], ppredblk[bx + 4][by + 4] );

            M15 = _mm_set_epi32( ppredblk[bx + 3][by + 5], ppredblk[bx + 2][by + 5], ppredblk[bx + 1][by + 5], ppredblk[bx + 0][by + 5] );
            M25 = _mm_set_epi32( ppredblk[bx + 7][by + 5], ppredblk[bx + 6][by + 5], ppredblk[bx + 5][by + 5], ppredblk[bx + 4][by + 5] );

            M16 = _mm_set_epi32( ppredblk[bx + 3][by + 6], ppredblk[bx + 2][by + 6], ppredblk[bx + 1][by + 6], ppredblk[bx + 0][by + 6] );
            M26 = _mm_set_epi32( ppredblk[bx + 7][by + 6], ppredblk[bx + 6][by + 6], ppredblk[bx + 5][by + 6], ppredblk[bx + 4][by + 6] );

            M17 = _mm_set_epi32( ppredblk[bx + 3][by + 7], ppredblk[bx + 2][by + 7], ppredblk[bx + 1][by + 7], ppredblk[bx + 0][by + 7] );
            M27 = _mm_set_epi32( ppredblk[bx + 7][by + 7], ppredblk[bx + 6][by + 7], ppredblk[bx + 5][by + 7], ppredblk[bx + 4][by + 7] );
            ...
            M10 = _mm_set_epi32( ppredblk[3][by + 0], ppredblk[2][by + 0], ppredblk[1][by + 0], ppredblk[0][by + 0] );
            M20 = _mm_set_epi32( ppredblk[7][by + 0], ppredblk[6][by + 0], ppredblk[5][by + 0], ppredblk[4][by + 0] );
            M30 = _mm_set_epi32( ppredblk[11][by + 0], ppredblk[10][by + 0], ppredblk[9][by + 0], ppredblk[8][by + 0] );
            M40 = _mm_set_epi32( ppredblk[15][by + 0], ppredblk[14][by + 0], ppredblk[13][by + 0], ppredblk[12][by + 0] );

            M11 = _mm_set_epi32( ppredblk[3][by + 1], ppredblk[2][by + 1], ppredblk[1][by + 1], ppredblk[0][by + 1] );
            M21 = _mm_set_epi32( ppredblk[7][by + 1], ppredblk[6][by + 1], ppredblk[5][by + 1], ppredblk[4][by + 1] );
            M31 = _mm_set_epi32( ppredblk[11][by + 1], ppredblk[10][by + 1], ppredblk[9][by + 1], ppredblk[8][by + 1] );
            M41 = _mm_set_epi32( ppredblk[15][by + 1], ppredblk[14][by + 1], ppredblk[13][by + 1], ppredblk[12][by + 1] );

            M12 = _mm_set_epi32( ppredblk[3][by + 2], ppredblk[2][by + 2], ppredblk[1][by + 2], ppredblk[0][by + 2] );
            M22 = _mm_set_epi32( ppredblk[7][by + 2], ppredblk[6][by + 2], ppredblk[5][by + 2], ppredblk[4][by + 2] );
            M32 = _mm_set_epi32( ppredblk[11][by + 2], ppredblk[10][by + 2], ppredblk[9][by + 2], ppredblk[8][by + 2] );
            M42 = _mm_set_epi32( ppredblk[15][by + 2], ppredblk[14][by + 2], ppredblk[13][by + 2], ppredblk[12][by + 2] );

            M13 = _mm_set_epi32( ppredblk[3][by + 3], ppredblk[2][by + 3], ppredblk[1][by + 3], ppredblk[0][by + 3] );
            M23 = _mm_set_epi32( ppredblk[7][by + 3], ppredblk[6][by + 3], ppredblk[5][by + 3], ppredblk[4][by + 3] );
            M33 = _mm_set_epi32( ppredblk[11][by + 3], ppredblk[10][by + 3], ppredblk[9][by + 3], ppredblk[8][by + 3] );
            M43 = _mm_set_epi32( ppredblk[15][by + 3], ppredblk[14][by + 3], ppredblk[13][by + 3], ppredblk[12][by + 3] );

            M14 = _mm_set_epi32( ppredblk[3][by + 4], ppredblk[2][by + 4], ppredblk[1][by + 4], ppredblk[0][by + 4] );
            M24 = _mm_set_epi32( ppredblk[7][by + 4], ppredblk[6][by + 4], ppredblk[5][by + 4], ppredblk[4][by + 4] );
            M34 = _mm_set_epi32( ppredblk[11][by + 4], ppredblk[10][by + 4], ppredblk[9][by + 4], ppredblk[8][by + 4] );
            M44 = _mm_set_epi32( ppredblk[15][by + 4], ppredblk[14][by + 4], ppredblk[13][by + 4], ppredblk[12][by + 4] );

            M15 = _mm_set_epi32( ppredblk[3][by + 5], ppredblk[2][by + 5], ppredblk[1][by + 5], ppredblk[0][by + 5] );
            M25 = _mm_set_epi32( ppredblk[7][by + 5], ppredblk[6][by + 5], ppredblk[5][by + 5], ppredblk[4][by + 5] );
            M35 = _mm_set_epi32( ppredblk[11][by + 5], ppredblk[10][by + 5], ppredblk[9][by + 5], ppredblk[8][by + 5] );
            M45 = _mm_set_epi32( ppredblk[15][by + 5], ppredblk[14][by + 5], ppredblk[13][by + 5], ppredblk[12][by + 5] );

            M16 = _mm_set_epi32( ppredblk[3][by + 6], ppredblk[2][by + 6], ppredblk[1][by + 6], ppredblk[0][by + 6] );
            M26 = _mm_set_epi32( ppredblk[7][by + 6], ppredblk[6][by + 6], ppredblk[5][by + 6], ppredblk[4][by + 6] );
            M36 = _mm_set_epi32( ppredblk[11][by + 6], ppredblk[10][by + 6], ppredblk[9][by + 6], ppredblk[8][by + 6] );
            M46 = _mm_set_epi32( ppredblk[15][by + 6], ppredblk[14][by + 6], ppredblk[13][by + 6], ppredblk[12][by + 6] );

            M17 = _mm_set_epi32( ppredblk[3][by + 7], ppredblk[2][by + 7], ppredblk[1][by + 7], ppredblk[0][by + 7] );
            M27 = _mm_set_epi32( ppredblk[7][by + 7], ppredblk[6][by + 7], ppredblk[5][by + 7], ppredblk[4][by + 7] );
            M37 = _mm_set_epi32( ppredblk[11][by + 7], ppredblk[10][by + 7], ppredblk[9][by + 7], ppredblk[8][by + 7] );
            M47 = _mm_set_epi32( ppredblk[15][by + 7], ppredblk[14][by + 7], ppredblk[13][by + 7], ppredblk[12][by + 7] );

            M18 = _mm_set_epi32( ppredblk[3][by + 8], ppredblk[2][by + 8], ppredblk[1][by + 8], ppredblk[0][by + 8] );
            M28 = _mm_set_epi32( ppredblk[7][by + 8], ppredblk[6][by + 8], ppredblk[5][by + 8], ppredblk[4][by + 8] );
            M38 = _mm_set_epi32( ppredblk[11][by + 8], ppredblk[10][by + 8], ppredblk[9][by + 8], ppredblk[8][by + 8] );
            M48 = _mm_set_epi32( ppredblk[15][by + 8], ppredblk[14][by + 8], ppredblk[13][by + 8], ppredblk[12][by + 8] );

            M19 = _mm_set_epi32( ppredblk[3][by + 9], ppredblk[2][by + 9], ppredblk[1][by + 9], ppredblk[0][by + 9] );
            M29 = _mm_set_epi32( ppredblk[7][by + 9], ppredblk[6][by + 9], ppredblk[5][by + 9], ppredblk[4][by + 9] );
            M39 = _mm_set_epi32( ppredblk[11][by + 9], ppredblk[10][by + 9], ppredblk[9][by + 9], ppredblk[8][by + 9] );
            M49 = _mm_set_epi32( ppredblk[15][by + 9], ppredblk[14][by + 9], ppredblk[13][by + 9], ppredblk[12][by + 9] );

            M1A = _mm_set_epi32( ppredblk[3][by + 10], ppredblk[2][by + 10], ppredblk[1][by + 10], ppredblk[0][by + 10] );
            M2A = _mm_set_epi32( ppredblk[7][by + 10], ppredblk[6][by + 10], ppredblk[5][by + 10], ppredblk[4][by + 10] );
            M3A = _mm_set_epi32( ppredblk[11][by + 10], ppredblk[10][by + 10], ppredblk[9][by + 10], ppredblk[8][by + 10] );
            M4A = _mm_set_epi32( ppredblk[15][by + 10], ppredblk[14][by + 10], ppredblk[13][by + 10], ppredblk[12][by + 10] );

            M1B = _mm_set_epi32( ppredblk[3][by + 11], ppredblk[2][by + 11], ppredblk[1][by + 11], ppredblk[0][by + 11] );
            M2B = _mm_set_epi32( ppredblk[7][by + 11], ppredblk[6][by + 11], ppredblk[5][by + 11], ppredblk[4][by + 11] );
            M3B = _mm_set_epi32( ppredblk[11][by + 11], ppredblk[10][by + 11], ppredblk[9][by + 11], ppredblk[8][by + 11] );
            M4B = _mm_set_epi32( ppredblk[15][by + 11], ppredblk[14][by + 11], ppredblk[13][by + 11], ppredblk[12][by + 11] );

            M1C = _mm_set_epi32( ppredblk[3][by + 12], ppredblk[2][by + 12], ppredblk[1][by + 12], ppredblk[0][by + 12] );
            M2C = _mm_set_epi32( ppredblk[7][by + 12], ppredblk[6][by + 12], ppredblk[5][by + 12], ppredblk[4][by + 12] );
            M3C = _mm_set_epi32( ppredblk[11][by + 12], ppredblk[10][by + 12], ppredblk[9][by + 12], ppredblk[8][by + 12] );
            M4C = _mm_set_epi32( ppredblk[15][by + 12], ppredblk[14][by + 12], ppredblk[13][by + 12], ppredblk[12][by + 12] );

            M1D = _mm_set_epi32( ppredblk[3][by + 13], ppredblk[2][by + 13], ppredblk[1][by + 13], ppredblk[0][by + 13] );
            M2D = _mm_set_epi32( ppredblk[7][by + 13], ppredblk[6][by + 13], ppredblk[5][by + 13], ppredblk[4][by + 13] );
            M3D = _mm_set_epi32( ppredblk[11][by + 13], ppredblk[10][by + 13], ppredblk[9][by + 13], ppredblk[8][by + 13] );
            M4D = _mm_set_epi32( ppredblk[15][by + 13], ppredblk[14][by + 13], ppredblk[13][by + 13], ppredblk[12][by + 13] );

            M1E = _mm_set_epi32( ppredblk[3][by + 14], ppredblk[2][by + 14], ppredblk[1][by + 14], ppredblk[0][by + 14] );
            M2E = _mm_set_epi32( ppredblk[7][by + 14], ppredblk[6][by + 14], ppredblk[5][by + 14], ppredblk[4][by + 14] );
            M3E = _mm_set_epi32( ppredblk[11][by + 14], ppredblk[10][by + 14], ppredblk[9][by + 14], ppredblk[8][by + 14] );
            M4E = _mm_set_epi32( ppredblk[15][by + 14], ppredblk[14][by + 14], ppredblk[13][by + 14], ppredblk[12][by + 14] );

            M1F = _mm_set_epi32( ppredblk[3][by + 15], ppredblk[2][by + 15], ppredblk[1][by + 15], ppredblk[0][by + 15] );
            M2F = _mm_set_epi32( ppredblk[7][by + 15], ppredblk[6][by + 15], ppredblk[5][by + 15], ppredblk[4][by + 15] );
            M3F = _mm_set_epi32( ppredblk[11][by + 15], ppredblk[10][by + 15], ppredblk[9][by + 15], ppredblk[8][by + 15] );
            M4F = _mm_set_epi32( ppredblk[15][by + 15], ppredblk[14][by + 15], ppredblk[13][by + 15], ppredblk[12][by + 15] );

            _mm_storeu_si128( ( __m128i* )( imgY + ( ipix_y + by )*iStride + ipix_x + bx + 4 ), T20 );
        ...
        else
        {
            ...
            M10 = _mm_set_epi32( ppredblk[bx + 3][by + 0], ppredblk[bx + 2][by + 0], ppredblk[bx + 1][by + 0], ppredblk[bx + 0][by + 0] );
            M20 = _mm_set_epi32( ppredblk[bx + 7][by + 0], ppredblk[bx + 6][by + 0], ppredblk[bx + 5][by + 0], ppredblk[bx + 4][by + 0] );
            M30 = _mm_set_epi32( ppredblk[bx + 11][by + 0], ppredblk[bx + 10][by + 0], ppredblk[bx + 9][by + 0], ppredblk[bx + 8][by + 0] );
            M40 = _mm_set_epi32( ppredblk[bx + 15][by + 0], ppredblk[bx + 14][by + 0], ppredblk[bx + 13][by + 0], ppredblk[bx + 12][by + 0] );

            M11 = _mm_set_epi32( ppredblk[bx + 3][by + 1], ppredblk[bx + 2][by + 1], ppredblk[bx + 1][by + 1], ppredblk[bx + 0][by + 1] );
            M21 = _mm_set_epi32( ppredblk[bx + 7][by + 1], ppredblk[bx + 6][by + 1], ppredblk[bx + 5][by + 1], ppredblk[bx + 4][by + 1] );
            M31 = _mm_set_epi32( ppredblk[bx + 11][by + 1], ppredblk[bx + 10][by + 1], ppredblk[bx + 9][by + 1], ppredblk[bx + 8][by + 1] );
            M41 = _mm_set_epi32( ppredblk[bx + 15][by + 1], ppredblk[bx + 14][by + 1], ppredblk[bx + 13][by + 1], ppredblk[bx + 12][by + 1] );

            M12 = _mm_set_epi32( ppredblk[bx + 3][by + 2], ppredblk[bx + 2][by + 2], ppredblk[bx + 1][by + 2], ppredblk[bx + 0][by + 2] );
            M22 = _mm_set_epi32( ppredblk[bx + 7][by + 2], ppredblk[bx + 6][by + 2], ppredblk[bx + 5][by + 2], ppredblk[bx + 4][by + 2] );
            M32 = _mm_set_epi32( ppredblk[bx + 11][by + 2], ppredblk[bx + 10][by + 2], ppredblk[bx + 9][by + 2], ppredblk[bx + 8][by + 2] );
            M42 = _mm_set_epi32( ppredblk[bx + 15][by + 2], ppredblk[bx + 14][by + 2], ppredblk[bx + 13][by + 2], ppredblk[bx + 12][by + 2] );

            M13 = _mm_set_epi32( ppredblk[bx + 3][by + 3], ppredblk[bx + 2][by + 3], ppredblk[bx + 1][by + 3], ppredblk[bx + 0][by + 3] );
            M23 = _mm_set_epi32( ppredblk[bx + 7][by + 3], ppredblk[bx + 6][by + 3], ppredblk[bx + 5][by + 3], ppredblk[bx + 4][by + 3] );
            M33 = _mm_set_epi32( ppredblk[bx + 11][by + 3], ppredblk[bx + 10][by + 3], ppredblk[bx + 9][by + 3], ppredblk[bx + 8][by + 3] );
            M43 = _mm_set_epi32( ppredblk[bx + 15][by + 3], ppredblk[bx + 14][by + 3], ppredblk[bx + 13][by + 3], ppredblk[bx + 12][by + 3] );

            M14 = _mm_set_epi32( ppredblk[bx + 3][by + 4], ppredblk[bx + 2][by + 4], ppredblk[bx + 1][by + 4], ppredblk[bx + 0][by + 4] );
            M24 = _mm_set_epi32( ppredblk[bx + 7][by + 4], ppredblk[bx + 6][by + 4], ppredblk[bx + 5][by + 4], ppredblk[bx + 4][by + 4] );
            M34 = _mm_set_epi32( ppredblk[bx + 11][by + 4], ppredblk[bx + 10][by + 4], ppredblk[bx + 9][by + 4], ppredblk[bx + 8][by + 4] );
            M44 = _mm_set_epi32( ppredblk[bx + 15][by + 4], ppredblk[bx + 14][by + 4], ppredblk[bx + 13][by + 4], ppredblk[bx + 12][by + 4] );

            M15 = _mm_set_epi32( ppredblk[bx + 3][by + 5], ppredblk[bx + 2][by + 5], ppredblk[bx + 1][by + 5], ppredblk[bx + 0][by + 5] );
            M25 = _mm_set_epi32( ppredblk[bx + 7][by + 5], ppredblk[bx + 6][by + 5], ppredblk[bx + 5][by + 5], ppredblk[bx + 4][by + 5] );
            M35 = _mm_set_epi32( ppredblk[bx + 11][by + 5], ppredblk[bx + 10][by + 5], ppredblk[bx + 9][by + 5], ppredblk[bx + 8][by + 5] );
            M45 = _mm_set_epi32( ppredblk[bx + 15][by + 5], ppredblk[bx + 14][by + 5], ppredblk[bx + 13][by + 5], ppredblk[bx + 12][by + 5] );

            M16 = _mm_set_epi32( ppredblk[bx + 3][by + 6], ppredblk[bx + 2][by + 6], ppredblk[bx + 1][by + 6], ppredblk[bx + 0][by + 6] );
            M26 = _mm_set_epi32( ppredblk[bx + 7][by + 6], ppredblk[bx + 6][by + 6], ppredblk[bx + 5][by + 6], ppredblk[bx + 4][by + 6] );
            M36 = _mm_set_epi32( ppredblk[bx + 11][by + 6], ppredblk[bx + 10][by + 6], ppredblk[bx + 9][by + 6], ppredblk[bx + 8][by + 6] );
            M46 = _mm_set_epi32( ppredblk[bx + 15][by + 6], ppredblk[bx + 14][by + 6], ppredblk[bx + 13][by + 6], ppredblk[bx + 12][by + 6] );

            M17 = _mm_set_epi32( ppredblk[bx + 3][by + 7], ppredblk[bx + 2][by + 7], ppredblk[bx + 1][by + 7], ppredblk[bx + 0][by + 7] );
            M27 = _mm_set_epi32( ppredblk[bx + 7][by + 7], ppredblk[bx + 6][by + 7], ppredblk[bx + 5][by + 7], ppredblk[bx + 4][by + 7] );
            M37 = _mm_set_epi32( ppredblk[bx + 11][by + 7], ppredblk[bx + 10][by + 7], ppredblk[bx + 9][by + 7], ppredblk[bx + 8][by + 7] );
            M47 = _mm_set_epi32( ppredblk[bx + 15][by + 7], ppredblk[bx + 14][by + 7], ppredblk[bx + 13][by + 7], ppredblk[bx + 12][by + 7] );

            M18 = _mm_set_epi32( ppredblk[bx + 3][by + 8], ppredblk[bx + 2][by + 8], ppredblk[bx + 1][by + 8], ppredblk[bx + 0][by + 8] );
            M28 = _mm_set_epi32( ppredblk[bx + 7][by + 8], ppredblk[bx + 6][by + 8], ppredblk[bx + 5][by + 8], ppredblk[bx + 4][by + 8] );
            M38 = _mm_set_epi32( ppredblk[bx + 11][by + 8], ppredblk[bx + 10][by + 8], ppredblk[bx + 9][by + 8], ppredblk[bx + 8][by + 8] );
            M48 = _mm_set_epi32( ppredblk[bx + 15][by + 8], ppredblk[bx + 14][by + 8], ppredblk[bx + 13][by + 8], ppredblk[bx + 12][by + 8] );

            M19 = _mm_set_epi32( ppredblk[bx + 3][by + 9], ppredblk[bx + 2][by + 9], ppredblk[bx + 1][by + 9], ppredblk[bx + 0][by + 9] );
            M29 = _mm_set_epi32( ppredblk[bx + 7][by + 9], ppredblk[bx + 6][by + 9], ppredblk[bx + 5][by + 9], ppredblk[bx + 4][by + 9] );
            M39 = _mm_set_epi32( ppredblk[bx + 11][by + 9], ppredblk[bx + 10][by + 9], ppredblk[bx + 9][by + 9], ppredblk[bx + 8][by + 9] );
            M49 = _mm_set_epi32( ppredblk[bx + 15][by + 9], ppredblk[bx + 14][by + 9], ppredblk[bx + 13][by + 9], ppredblk[bx + 12][by + 9] );

            M1A = _mm_set_epi32( ppredblk[bx + 3][by + 10], ppredblk[bx + 2][by + 10], ppredblk[bx + 1][by + 10], ppredblk[bx + 0][by + 10] );
            M2A = _mm_set_epi32( ppredblk[bx + 7][by + 10], ppredblk[bx + 6][by + 10], ppredblk[bx + 5][by + 10], ppredblk[bx + 4][by + 10] );
            M3A = _mm_set_epi32( ppredblk[bx + 11][by + 10], ppredblk[bx + 10][by + 10], ppredblk[bx + 9][by + 10], ppredblk[bx + 8][by + 10] );
            M4A = _mm_set_epi32( ppredblk[bx + 15][by + 10], ppredblk[bx + 14][by + 10], ppredblk[bx + 13][by + 10], ppredblk[bx + 12][by + 10] );

            M1B = _mm_set_epi32( ppredblk[bx + 3][by + 11], ppredblk[bx + 2][by + 11], ppredblk[bx + 1][by + 11], ppredblk[bx + 0][by + 11] );
            M2B = _mm_set_epi32( ppredblk[bx + 7][by + 11], ppredblk[bx + 6][by + 11], ppredblk[bx + 5][by + 11], ppredblk[bx + 4][by + 11] );
            M3B = _mm_set_epi32( ppredblk[bx + 11][by + 11], ppredblk[bx + 10][by + 11], ppredblk[bx + 9][by + 11], ppredblk[bx + 8][by + 11] );
            M4B = _mm_set_epi32( ppredblk[bx + 15][by + 11], ppredblk[bx + 14][by + 11], ppredblk[bx + 13][by + 11], ppredblk[bx + 12][by + 11] );

            M1C = _mm_set_epi32( ppredblk[bx + 3][by + 12], ppredblk[bx + 2][by + 12], ppredblk[bx + 1][by + 12], ppredblk[bx + 0][by + 12] );
            M2C = _mm_set_epi32( ppredblk[bx + 7][by + 12], ppredblk[bx + 6][by + 12], ppredblk[bx + 5][by + 12], ppredblk[bx + 4][by + 12] );
            M3C = _mm_set_epi32( ppredblk[bx + 11][by + 12], ppredblk[bx + 10][by + 12], ppredblk[bx + 9][by + 12], ppredblk[bx + 8][by + 12] );
            M4C = _mm_set_epi32( ppredblk[bx + 15][by + 12], ppredblk[bx + 14][by + 12], ppredblk[bx + 13][by + 12], ppredblk[bx + 12][by + 12] );

            M1D = _mm_set_epi32( ppredblk[bx + 3][by + 13], ppredblk[bx + 2][by + 13], ppredblk[bx + 1][by + 13], ppredblk[bx + 0][by + 13] );
            M2D = _mm_set_epi32( ppredblk[bx + 7][by + 13], ppredblk[bx + 6][by + 13], ppredblk[bx + 5][by + 13], ppredblk[bx + 4][by + 13] );
            M3D = _mm_set_epi32( ppredblk[bx + 11][by + 13], ppredblk[bx + 10][by + 13], ppredblk[bx + 9][by + 13], ppredblk[bx + 8][by + 13] );
            M4D = _mm_set_epi32( ppredblk[bx + 15][by + 13], ppredblk[bx + 14][by + 13], ppredblk[bx + 13][by + 13], ppredblk[bx + 12][by + 13] );

            M1E = _mm_set_epi32( ppredblk[bx + 3][by + 14], ppredblk[bx + 2][by + 14], ppredblk[bx + 1][by + 14], ppredblk[bx + 0][by + 14] );
            M2E = _mm_set_epi32( ppredblk[bx + 7][by + 14], ppredblk[bx + 6][by + 14], ppredblk[bx + 5][by + 14], ppredblk[bx + 4][by + 14] );
            M3E = _mm_set_epi32( ppredblk[bx + 11][by + 14], ppredblk[bx + 10][by + 14], ppredblk[bx + 9][by + 14], ppredblk[bx + 8][by + 14] );
            M4E = _mm_set_epi32( ppredblk[bx + 15][by + 14], ppredblk[bx + 14][by + 14], ppredblk[bx + 13][by + 14], ppredblk[bx + 12][by + 14] );

            M1F = _mm_set_epi32( ppredblk[bx + 3][by + 15], ppredblk[bx + 2][by + 15], ppredblk[bx + 1][by + 15], ppredblk[bx + 0][by + 15] );
            M2F = _mm_set_epi32( ppredblk[bx + 7][by + 15], ppredblk[bx + 6][by + 15], ppredblk[bx + 5][by + 15], ppredblk[bx + 4][by + 15] );
            M3F = _mm_set_epi32( ppredblk[bx + 11][by + 15], ppredblk[bx + 10][by + 15], ppredblk[bx + 9][by + 15], ppredblk[bx + 8][by + 15] );
            M4F = _mm_set_epi32( ppredblk[bx + 15][by + 15], ppredblk[bx + 14][by + 15], ppredblk[bx + 13][by + 15], ppredblk[bx + 12][by + 15] );
...
#undef TRANSPOSE_8x8_16BI
    ...
    else
    {
        ...
        if ( 4 == bsize )
        {
            ...
            M0 = _mm_set_epi32( ppredblk[3][0], ppredblk[2][0], ppredblk[1][0], ppredblk[0][0] );
            M1 = _mm_set_epi32( ppredblk[3][1], ppredblk[2][1], ppredblk[1][1], ppredblk[0][1] );
            M2 = _mm_set_epi32( ppredblk[3][2], ppredblk[2][2], ppredblk[1][2], ppredblk[0][2] );
            M3 = _mm_set_epi32( ppredblk[3][3], ppredblk[2][3], ppredblk[1][3], ppredblk[0][3] );
        ...
        else if ( 8 == bsize )
        {
            ...
            M10 = _mm_set_epi32( ppredblk[3][0], ppredblk[2][0], ppredblk[1][0], ppredblk[0][0] );
            M20 = _mm_set_epi32( ppredblk[7][0], ppredblk[6][0], ppredblk[5][0], ppredblk[4][0] );

            M11 = _mm_set_epi32( ppredblk[3][1], ppredblk[2][1], ppredblk[1][1], ppredblk[0][1] );
            M21 = _mm_set_epi32( ppredblk[7][1], ppredblk[6][1], ppredblk[5][1], ppredblk[4][1] );

            M12 = _mm_set_epi32( ppredblk[3][2], ppredblk[2][2], ppredblk[1][2], ppredblk[0][2] );
            M22 = _mm_set_epi32( ppredblk[7][2], ppredblk[6][2], ppredblk[5][2], ppredblk[4][2] );

            M13 = _mm_set_epi32( ppredblk[3][3], ppredblk[2][3], ppredblk[1][3], ppredblk[0][3] );
            M23 = _mm_set_epi32( ppredblk[7][3], ppredblk[6][3], ppredblk[5][3], ppredblk[4][3] );

            M14 = _mm_set_epi32( ppredblk[3][4], ppredblk[2][4], ppredblk[1][4], ppredblk[0][4] );
            M24 = _mm_set_epi32( ppredblk[7][4], ppredblk[6][4], ppredblk[5][4], ppredblk[4][4] );

            M15 = _mm_set_epi32( ppredblk[3][5], ppredblk[2][5], ppredblk[1][5], ppredblk[0][5] );
            M25 = _mm_set_epi32( ppredblk[7][5], ppredblk[6][5], ppredblk[5][5], ppredblk[4][5] );

            M16 = _mm_set_epi32( ppredblk[3][6], ppredblk[2][6], ppredblk[1][6], ppredblk[0][6] );
            M26 = _mm_set_epi32( ppredblk[7][6], ppredblk[6][6], ppredblk[5][6], ppredblk[4][6] );

            M17 = _mm_set_epi32( ppredblk[3][7], ppredblk[2][7], ppredblk[1][7], ppredblk[0][7] );
            M27 = _mm_set_epi32( ppredblk[7][7], ppredblk[6][7], ppredblk[5][7], ppredblk[4][7] );
            ...
            if ( ( b8 - 4 ) % 2 )
            {
                ...
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y)*iStrideC + ipix_c_x + 4), T20);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 1 )*iStrideC + ipix_c_x ), T11 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 1)*iStrideC + ipix_c_x + 4), T21);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 2 )*iStrideC + ipix_c_x ), T12 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 2)*iStrideC + ipix_c_x + 4), T22);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 3 )*iStrideC + ipix_c_x ), T13 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 3)*iStrideC + ipix_c_x + 4), T23);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 4 )*iStrideC + ipix_c_x ), T14 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 4)*iStrideC + ipix_c_x + 4), T24);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 5 )*iStrideC + ipix_c_x ), T15 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 5)*iStrideC + ipix_c_x + 4), T25);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 6 )*iStrideC + ipix_c_x ), T16 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 6)*iStrideC + ipix_c_x + 4), T26);
                _mm_storel_epi64( ( __m128i* )( imgV + ( ipix_c_y + 7 )*iStrideC + ipix_c_x ), T17 );
                //_mm_storeu_si128((__m128i*)(imgV + (ipix_c_y + 7)*iStrideC + ipix_c_x + 4), T27);
            }
            else
            {
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y )*iStrideC + ipix_c_x ), T10 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y)*iStrideC + ipix_c_x + 4), T20);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 1 )*iStrideC + ipix_c_x ), T11 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 1)*iStrideC + ipix_c_x + 4), T21);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 2 )*iStrideC + ipix_c_x ), T12 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 2)*iStrideC + ipix_c_x + 4), T22);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 3 )*iStrideC + ipix_c_x ), T13 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 3)*iStrideC + ipix_c_x + 4), T23);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 4 )*iStrideC + ipix_c_x ), T14 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 4)*iStrideC + ipix_c_x + 4), T24);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 5 )*iStrideC + ipix_c_x ), T15 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 5)*iStrideC + ipix_c_x + 4), T25);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 6 )*iStrideC + ipix_c_x ), T16 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 6)*iStrideC + ipix_c_x + 4), T26);
                _mm_storel_epi64( ( __m128i* )( imgU + ( ipix_c_y + 7 )*iStrideC + ipix_c_x ), T17 );
                //_mm_storeu_si128((__m128i*)(imgU + (ipix_c_y + 7)*iStrideC + ipix_c_x + 4), T27);
            }
...
//
//  for (; i < height; i++) {
//      S1 = _mm_lddqu_si128((__m128i*)(src1));
//      S2 = _mm_lddqu_si128((__m128i*)(src2));
//      D = _mm_avg_epu8(S1, S2);
//      _mm_maskmoveu_si128(D, mask, (char_t*)&dst[0]);
//
//      src1 += i_src1;
//      src2 += i_src2;
//      dst += i_dst;
...
#ifdef MT_ENABLE
void padding_rows_LR_mt_sse128( pel_t *src, int i_src, int width, int height, int pad, int mb_row, bool uv_flag )
{
    int i, j;
    int pad_lr;
    int p_offset;
    pel_t *p, *p1, *p2;
    i32s_t pad_rows = MICROBLOCK_ROWNUM;
    pad_lr = pad + 16 - ( pad & 0xF );

    p_offset = ( mb_row << 4 ) * i_src;
