/******************************************************************
        Internet Video Coding(IVC) Reference Software Manual
******************************************************************/
please send comments and additions to rgwang@pkusz.edu.cn
...
1.1 Windows
  ...
  A workspace for MS Visual C++ is provided with the name "ITM_x.sln". It contains
...
2. Command line parameters
  ...
  2.1 Encoder
     ...
     All Parameters are initially taken from the 'file ', typically: "encoder_ra.cfg"
...
3. Input/Output file format
   ...
   For encoder, the input files should be the 4:2:0 data files and the output is *.bit 
   which is the stream of IVC standard.
   For decoder, the input files should be the IVC standard streams and the output is 
...
5. Copyright
   ...
   Please refer the copyright.txt for copyright information.
